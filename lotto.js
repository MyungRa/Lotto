...
function displayNumbers(){
    const numberContainer = $("<div class='dNumbers'></div>")
    for(let i = 0; i < 6; i++){
...
function createLottoNumbers(){
    ...
    intervalId = setInterval(pointNumbers, 400)
}
